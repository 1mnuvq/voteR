...
const AdminDashboard = () => {
  ...
  const fetchData = async () => {
    try {
      const resStudents = await fetch(`${process.env.API_URL}/admin/students`);
      const resVotes = await fetch(`${process.env.API_URL}/admin/votes`);
      const resPending = await fetch(`${process.env.API_URL}/admin/pending-candidates`);
  ...
  const handleApprove = async (collegeId) => {
    try {
      const res = await fetch(`${process.env.API_URL}/admin/approve-candidate`, {
        method: "POST",
